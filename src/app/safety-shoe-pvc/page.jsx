...
const page = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <h1 className="text-3xl md:text-4xl font-extrabold text-center text-[#DD2B1C] mb-10">Safety Shoe PVC</h1>
      ...
      {!safetyShoesPVC && (
        <p className="text-center text-gray-500 mt-8">No products found in Safety Shoe PVC category</p>
      )}
    </div>
  )
}
