...
const page = () => {
  // Safety Shoe PU category se products nikalna
  const safetyShoesPU = productData.categories.find(category => 
    category.name === "Safety Shoe PU"
  )
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <h1 className="text-3xl md:text-4xl font-extrabold text-center text-[#DD2B1C] mb-10">Safety Shoe PU</h1>

      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {safetyShoesPU && safetyShoesPU.products.map((product, index) => {
      ...
      {!safetyShoesPU && (
        <p className="text-center text-gray-500 mt-8">No products found in Safety Shoe PU category</p>
      )}
    </div>
  )
}
