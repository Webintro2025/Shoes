    ...
    <section className="max-w-7xl mx-auto px-2 sm:px-4 py-8 sm:py-10">
      <div className="flex flex-col lg:flex-row gap-8 sm:gap-10">
        ...
        <div className="lg:w-1/2 flex flex-col justify-center">
          ...
          <div className="bg-gradient-to-br from-[#fff7ed] via-white to-[#fee2e2] border-l-4 sm:border-l-8 border-black shadow-xl rounded-2xl p-4 sm:p-6 md:p-10 max-w-xl mx-auto flex flex-col gap-4 sm:gap-7">
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="bg-black text-white rounded-full p-2 sm:p-3 text-base sm:text-xl">
