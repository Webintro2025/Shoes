  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-red-700 text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-sm hover:bg-red-800 transition-colors text-xs sm:text-sm disabled:opacity-70 disabled:cursor-not-allowed"
      >
